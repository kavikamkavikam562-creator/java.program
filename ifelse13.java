...
public class ifelse13 {
    public static void main(String[] args) {
        ...
        if (studentStatus.equals("Full-Time")) {
            activityFee = 200;
            if (programType.equals("Undergraduate")) programFee = 500;
            else if (programType.equals("Graduate")) programFee = 750;
            else programFee = 1200;
        } else if (studentStatus.equals("Part-Time")) {
            activityFee = 100;
            if (programType.equals("Undergraduate")) programFee = 300;
            else if (programType.equals("Graduate")) programFee = 750;
            else programFee = 900;
        } else {
            activityFee = 50;
